...
func largestValue(in arrayOfInts: [Int]) -> Int {
    ...
    let result = arrayOfInts.reduce(0) { prevResult, currentValue in
...
// Your function here
func sortedNamesByLastName(in arrayOfTuples : [ (String, String) ]) -> [(String, String)]  {
    arrayOfTuples.sorted { $0.1 < $1.1}
}
// Uncomment out the following lines to check your solution
